...
<div id="content" class="first-block block clearfix">
    <img class="banner" src="UI/jous/banner.png" >
    <div id="frame" class="clearfix">
        <ul class="content-nav cannot_select">
            <li id="currentA" data-url='./partpage/part-jous-hire.php'>顺风招聘</li>
            <li data-url='./partpage/part-jous-contact.php'>联系我们</li>

        </ul>
        <div class="content-detail">
            <iframe id="content-frame" width="100%" onload="this.style.height = this.contentDocument.body.scrollHeight+10+'px';" src="./partpage/part-jous-hire.php" ></iframe>
        </div>
        <script>
